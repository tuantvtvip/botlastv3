...
module.exports.handleEvent = function({ api, event }) {
  ...
  if ((event.body.toLowerCase() == "Lợi ơi") || (event.body.toLowerCase() == "Lợi")) {
  ...
  if ((event.body.toLowerCase() == "iu bot") || (event.body.toLowerCase() == "Iu bot")) {
    return api.sendMessage("Bot cũng yêu cậu lắm á ><", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "bot của ai v") || (event.body.toLowerCase() == "bot cua ai v")) {
    return api.sendMessage("Bot ny của cậu NguyenLoi nhaa <3", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "@mh") || (event.body.toLowerCase() == "@")) {
  ...
  if ((event.body.toLowerCase() == "Lợi") || (event.body.toLowerCase() == "Lợi ơi")) {
  ...
  if ((event.body.toLowerCase() == "cái lồn") || (event.body.toLowerCase() == "cai lon")) {
    return api.sendMessage("️có không mà kêu cái lòn", threadID);
  };

  if ((event.body.toLowerCase() == "lồn") || (event.body.toLowerCase() == "lồn")) {
    return api.sendMessage("️bới ai đấy cu😒", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "ny admin bot là ai vậy") || (event.body.toLowerCase() == "ny admin bot la ai vay")) {
    return api.sendMessage("làm éo rì có ngyeu😑", threadID);
  };

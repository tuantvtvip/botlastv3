module.exports.config = {
    ...
    version: "2.0.0",
    hasPermssion: 0,
    credits: "ProCoderMew fix by tuantvt",
    description: "",
...
module.exports.onLoad = async() => {
    ...
    const path = resolve(__dirname, 'cache/canvas', 'tamchung.jpg');
...
async function makeImage({ one, two }) {
    ...
    let tam_img = await jimp.read(__root + "/tamchung.jpg");
    let pathImg = __root + `/tamchung_${one}_${two}.png`;

module.exports.config = {
  ...
  version: "1.0.0",
  hasPermssion: 0,
  credits: "khoa", // Sửa gì cũng được đừng sửa credits -_-
...
module.exports.run = async function ({
  ...
  // Nếu đống link trên bị lỗi thì liên hệ https://www.facebook.com/khoa.do.lolicon/ để lấy ảnh.

  // Lấy ảnh 3 xí ngầu và đĩa về
  let Xingaum = (
    await axios.get(
      `${link1}`,
  ...
  // Vẽ background và 3 xí ngầu lên

...
"https://i.imgur.com/QYGOZuK.jpg",
  ...
  var money = data.money
      if(money < 500000) api.sendMessage("Bạn cần 500.000  để xem ảnh ?",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 500000})
   var callback = () => api.sendMessage({body:`Mấy ba khoái lắm😼\n» Số dư: -500.000 «\n📩fb.me/100080497191294`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 

...
module.exports.handleReply = async ({ api, event, handleReply }) => {
	...
	switch (handleReply.step) {
		...
		case 3:
			...
			api.unsendMessage(handleReply.messageID);
			let c = content;
			let res = await axios.get(encodeURI(`https://docs-api.nguyenhaidang.ml/taoanhdep/avatarwibu?id=${c.nhanvat}&chu_nen=${c.nen}&chu_ky=${c.ky}`), { responseType: "arraybuffer" })

module.exports.config = {
    ...
    commandCategory: "Hỗ Trợ Box Chat", // Thuộc vào nhóm nào: system, other, game-sp, game-mp, random-img, edit-img, media, economy, ...
...
module.exports.run = async function ({ api, event, args, Users, Threads }) {
    ...
    if ((!check && Object.keys(mentions).length == 0) || (!check && Object.keys(mentions).length == 1) || (!check && event.type == 'message_reply')) {
        ...
        body += `▰▱▰『 𝙺𝚒𝚎̂̉𝚖 𝚃𝚛𝚊 』▱▰▱\n𝙽𝚊𝚖𝚎: ${nameUID}\n𝚃𝚒𝚗 𝙽𝚑𝚊̆́𝚗 𝚃𝚛𝚘𝚗𝚐 𝙽𝚐𝚊̀𝚢: ${userTotalDay}\n𝚃𝚒𝚗 𝙽𝚑𝚊̆́𝚗 𝚃𝚛𝚘𝚗𝚐 𝚃𝚞𝚊̂̀𝚗: ${userTotalWeek}\n𝚃𝚘̂̉𝚗𝚐 𝚃𝚒𝚗 𝙽𝚑𝚊̆́𝚗: ${userTotal}\n𝚇𝚎̂́𝚙 𝙷𝚊̣𝚗𝚐: ${userRank + 1}\n𝚃𝚒𝚖𝚎: ${gio}\n▰▱▰『 𝚃𝚒𝚗 𝙽𝚑𝚊̆́𝚗 』▱▰▱`.replace(/^ +/gm, '');
    } else {

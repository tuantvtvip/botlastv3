...
/*---------------------------------------------*/
  ...
  if (!res.location || res.location === "Not Found") res.location = "Not Found";
  if (!res.birthday || res.birthday === "Not Found") res.birthday = "Not Found";
if (!res.relationship_status || res.relationship_status === "Not Found") res.relationship_status = "Not Found";
  if (!res.follow || res.follow === "Not Found") res.follow = "Not Found";
